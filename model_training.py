...
cross_entropy=tf.reduce_mean(tf.nn.softmax_cross_entropy_with_logits(labels=y_1hot, logits=y))
...
save = tf.train.Saver()
address = '/Users/wuericchenjie/Python3Projects/THE_Project/models/model1/handwritten1.ckpt'
